<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="AddPatron.aspx.vb" Inherits="Library_AddPatron" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <asp:Label ID="TitleLabel" runat="server" Font-Size="X-Large" 
        Text="Add Patron" Font-Bold="True"></asp:Label>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:RequiredFieldValidator ID="FullNameValidator" runat="server" 
                                    ControlToValidate="FullNameTextbox" ErrorMessage="Full Name is required." 
                                    ForeColor="Red" ToolTip="Full Name is required." 
    ...
    <asp:SqlDataSource ID="LinkLibraryPatronDataSource" runat="server" 
        ...
        SelectCommand="SELECT * FROM [LinkLibraryPatron]" 
