<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false"
    CodeFile="EditSubjects.aspx.vb" Inherits="Library_EditSubjects" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <asp:Label ID="TitleLabel" runat="server" Font-Size="X-Large" 
        Text="Edit Subjects" Font-Bold="True"></asp:Label>
    ...
    <asp:SqlDataSource ID="SqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ApplicationServices %>"
        ...
        InsertCommand="INSERT INTO [Subjects] ([Name], [Description]) VALUES (@Name, @Description)" SelectCommand="SELECT * FROM [Subjects]"
        
        UpdateCommand="UPDATE [Subjects] SET [Name] = @Name, [Description] = @Description WHERE [SubjectID] = @SubjectID">
        <DeleteParameters>
    ...
    <asp:ListView ID="ListView1" runat="server" DataKeyNames="SubjectID" 
