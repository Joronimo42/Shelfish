<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false"
    CodeFile="LinkMediaSubject.aspx.vb" Inherits="Library_Media_LinkMediaSubject" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <asp:Label ID="TitleLabel" runat="server" Font-Bold="True" Font-Size="X-Large" Text="Link Media to Subjects"></asp:Label>
    <br />
    <br />
    <asp:ListBox ID="ListBox" runat="server" DataSourceID="LinkMediaSubjectDataSource"
        DataTextField="Name" DataValueField="MediaSubjectID" Width="291px"></asp:ListBox>
    <table>
        <tr>
            <td>
        ...
        <tr>
            ...
            <td class="style1">
                <asp:DropDownList ID="SubjectDDL" runat="server" DataSourceID="SubjectsDataSource"
                    DataTextField="Name" DataValueField="SubjectID">
                </asp:DropDownList>
            </td>
            <td class="style2">
                <asp:HyperLink ID="EditSubjectsHyperlink" runat="server" NavigateUrl="~/Library/EditSubjects.aspx">Edit Subjects</asp:HyperLink>
            </td>
        </tr>
        <tr>
            <td>
    ...
    <asp:SqlDataSource ID="LinkMediaSubjectDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ApplicationServices %>"
    ...
    <asp:SqlDataSource ID="SubjectsDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ApplicationServices %>"
        SelectCommand="SELECT * FROM [Subjects]" DeleteCommand="DELETE FROM LinkMediaSubject WHERE (MediaID = @MediaID)">
        <DeleteParameters>
