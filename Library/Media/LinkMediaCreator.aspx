<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="LinkMediaCreator.aspx.vb" Inherits="Library_Media_LinkMediaCreator" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    <asp:Label ID="TitleLabel" runat="server" Font-Bold="True" Font-Size="X-Large" 
        Text="Link Media to Creators"></asp:Label>
    <br />
    <br />
    <asp:ListBox ID="ListBox" runat="server" 
        DataSourceID="LinkMediaCreatorDataSource" DataTextField="DisplayCreator" 
        DataValueField="MediaCreatorID" Width="291px"></asp:ListBox>
    <table>
    <tr>
    <td>
    ...
    <td>
        Creator:</td>
    <td class="style1">
        <asp:DropDownList ID="CreatorDDL" runat="server" 
            DataSourceID="CreatorDataSource" DataTextField="Name" 
            DataValueField="CreatorID">
        </asp:DropDownList>
    </td>
    <td class="style2">
        <asp:HyperLink ID="EditCreatorsHyperlink" runat="server" 
            NavigateUrl="~/Library/EditCreators.aspx">Edit Creators</asp:HyperLink>
    </td>
    </tr>
    <tr>
    <td>
        Creator&#39;s Role:</td>
    <td class="style1">
        <asp:DropDownList ID="CreatorRoleDDL" runat="server" 
            DataSourceID="CreatorRoleDataSource" DataTextField="CreatorRole" 
            DataValueField="CreatorRoleID">
        </asp:DropDownList>
    </td>
    <td class="style2">
        <asp:HyperLink ID="EditCreatorRolesHyperlink" runat="server" 
            NavigateUrl="~/Library/EditCreatorRoles.aspx">Edit Creator Roles</asp:HyperLink>
    </td>
    </tr>
    <tr>
    <td>
    ...
    <asp:SqlDataSource ID="LinkMediaCreatorDataSource" runat="server" 
    ...
    <asp:SqlDataSource ID="CreatorDataSource" runat="server" 
        ConnectionString="<%$ ConnectionStrings:ApplicationServices %>" 
        SelectCommand="SELECT * FROM [Creators]" 
        DeleteCommand="DELETE FROM LinkMediaCreator WHERE (MediaID = @MediaID)">
        <DeleteParameters>
            <asp:Parameter Name="MediaID" />
        </DeleteParameters>
    </asp:SqlDataSource>
    <asp:SqlDataSource ID="CreatorRoleDataSource" runat="server" 
        ConnectionString="<%$ ConnectionStrings:ApplicationServices %>" 
