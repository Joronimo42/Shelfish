<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="LinkMediaPublisher.aspx.vb" Inherits="Library_Media_LinkMediaPublisher" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    <asp:Label ID="TitleLabel" runat="server" Font-Bold="True" Font-Size="X-Large" 
        Text="Link Media to Publishers"></asp:Label>
    <br />
    <br />
    <asp:ListBox ID="ListBox" runat="server" 
        DataSourceID="LinkMediaPublisherDataSource" DataTextField="Name" 
        DataValueField="MediaPublisherID" Width="291px"></asp:ListBox>
    <table>
    <tr>
    <td>
    ...
    <td>
        Publisher:</td>
    <td class="style1">
        <asp:DropDownList ID="PublisherDDL" runat="server" 
            DataSourceID="PublisherDataSource" DataTextField="Name" 
            DataValueField="PublisherID">
        </asp:DropDownList>
    </td>
    <td class="style2">
        <asp:HyperLink ID="EditPublishersHyperlink" runat="server" 
    ...
    <asp:SqlDataSource ID="LinkMediaPublisherDataSource" runat="server" 
    ...
    <asp:SqlDataSource ID="PublisherDataSource" runat="server" 
        ...
        DeleteCommand="DELETE FROM LinkMediaPublisher WHERE (MediaID = @MediaID)">
        <DeleteParameters>
