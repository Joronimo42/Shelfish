<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="CheckoutResults.aspx.vb" Inherits="Library_CheckoutResults" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <asp:Label ID="TitleLabel" runat="server" Font-Size="X-Large" 
        Text="Checkout Results" Font-Bold="True"></asp:Label>
    ...
    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
        ...
        <LocalReport ReportPath="Reports\CheckoutDetails.rdlc">
            <DataSources>
                ...
                <rsweb:ReportDataSource DataSourceId="CheckoutByCheckoutID" 
                    Name="CheckoutByCheckoutID" />
            </DataSources>
        </LocalReport>
    </rsweb:ReportViewer>
    <asp:ObjectDataSource ID="CheckoutByCheckoutID" runat="server" 
        OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" 
        TypeName="ReportDataSetTableAdapters.CheckoutByCheckoutIDTableAdapter">
        <SelectParameters>
