<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false"
    CodeFile="Checkout.aspx.vb" Inherits="Library_Checkout" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <asp:Label ID="TitleLabel" runat="server" Font-Size="X-Large" Text="Checkout" Font-Bold="True"></asp:Label>
    <br />
    <asp:Label ID="ErrorLabel" runat="server" Font-Size="X-Large" ForeColor="Red" Text="All copies of this book are checked out!"
    ...
    <table>
        <tr>
            ...
            <td>
                <asp:Label ID="MediaResultLabel" runat="server" Text="MediaIDLabel" Visible="False"></asp:Label>
    ...
    <asp:SqlDataSource ID="CheckoutDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ApplicationServices %>"
        DeleteCommand="DELETE FROM [Checkouts] WHERE [CheckoutID] = @CheckoutID" InsertCommand="INSERT INTO [Checkouts] ([PatronID], [MediaID], [DueDate], [Renewals]) VALUES (@PatronID, @MediaID, @DueDate, @Renewals); SET @PK = SCOPE_IDENTITY()"
