<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false"
    CodeFile="PrintableMediaSummary.aspx.vb" Inherits="Library_PrintableMediaSummary" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <asp:ObjectDataSource ID="MediaDisplay" runat="server" OldValuesParameterFormatString="original_{0}"
        SelectMethod="GetData" TypeName="ReportDataSetTableAdapters.MediaDisplayTableAdapter">
    </asp:ObjectDataSource>
