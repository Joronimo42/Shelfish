<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="ManageRequests.aspx.vb" Inherits="Library_ManageRequests" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    <asp:SqlDataSource ID="RequestDataSource" runat="server" 
        ...
        InsertCommand="INSERT INTO [Requests] ([PatronID], [LibraryFromID], [LibraryToID], [MediaID], [Shipped]) VALUES (@PatronID, @LibraryFromID, @LibraryToID, @MediaID, @Shipped)" 
    ...
    <asp:SqlDataSource ID="LinkLibraryPatronMediaSource" runat="server" 
        ConnectionString="<%$ ConnectionStrings:ApplicationServices %>" 
    ...
    <td>MediaID:</td>
    <td>
        <asp:DropDownList ID="RequestDDL" runat="server" 
            DataSourceID="RequestDataSource" DataTextField="MediaID" 
