<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="BrowseAllMedia.aspx.vb" Inherits="Library_BrowseMedia" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <asp:Label ID="TitleLabel" runat="server" Font-Size="X-Large" 
        Text="Browse All Media" Font-Bold="True"></asp:Label>
    
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
        AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="MediaID" 
    ...
    <tr>
    <td><asp:Button ID="AddButton" runat="server" Text="Add Media" /></td>
    <td><asp:Button ID="EditButton" runat="server" Text="Edit Media" Visible="False" /></td>
    <td>
        <asp:Button ID="DeleteButton" runat="server" Text="Delete Media" />
        </td>
    <td><asp:Button ID="Checkout" runat="server" Text="Checkout" Visible="False" /></td>
    </tr>
    </table>
