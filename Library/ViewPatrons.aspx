<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false"
    CodeFile="ViewPatrons.aspx.vb" Inherits="Library_ViewPatrons" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <asp:Label ID="TitleLabel" runat="server" Font-Size="X-Large" Text="View Patrons"
        Font-Bold="True"></asp:Label>
    <asp:SqlDataSource ID="PatronDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ApplicationServices %>"
    ...
    <asp:SqlDataSource ID="CheckoutDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ApplicationServices %>"
        DeleteCommand="DELETE FROM [Checkouts] WHERE [CheckoutID] = @CheckoutID" InsertCommand="INSERT INTO [Checkouts] ([PatronID], [MediaID], [DueDate], [Renewals]) VALUES (@PatronID, @MediaID, @DueDate, @Renewals)"
    ...
    <asp:Label ID="ErrorLabel" runat="server" Font-Size="X-Large" ForeColor="Red" Text="User still has material checked out"
        Visible="False"></asp:Label>
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
        DataKeyNames="LibraryCard" DataSourceID="PatronDataSource">
        <Columns>
            <asp:CommandField ShowSelectButton="True" />
            <asp:BoundField DataField="LibraryCard" HeaderText="LibraryCard" InsertVisible="False"
                ReadOnly="True" SortExpression="LibraryCard" />
            <asp:BoundField DataField="UserName" HeaderText="UserName" SortExpression="UserName" />
            <asp:BoundField DataField="LateFees" HeaderText="LateFees" SortExpression="LateFees" />
        </Columns>
    </asp:GridView>
    <br />
    <table>
        <tr>
            ...
            <td>
                <asp:Button ID="DeleteButton" runat="server" Text="Delete User" Visible="False" />
            </td>
            <td>
                <asp:Button ID="LateFees" runat="server" Text="Manage Patron/Late Fees" Visible="False" />
            </td>
        </tr>
    </table>
</asp:Content>
