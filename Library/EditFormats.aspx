...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <asp:Label ID="TitleLabel" runat="server" Font-Size="X-Large" 
        Text="Edit Formats" Font-Bold="True"></asp:Label>
    
    <br />
    <asp:SqlDataSource ID="SqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ApplicationServices %>"
        DeleteCommand="DELETE FROM [Formats] WHERE [FormatID] = @FormatID" 
        InsertCommand="INSERT INTO [Formats] ([Name], [Abbreviation], [Description]) VALUES (@Name, @Abbreviation, @Description)" SelectCommand="SELECT * FROM [Formats]"
        
        UpdateCommand="UPDATE [Formats] SET [Name] = @Name, [Abbreviation] = @Abbreviation, [Description] = @Description WHERE [FormatID] = @FormatID">
        <DeleteParameters>
    ...
    <asp:ListView ID="ListView1" runat="server" DataKeyNames="FormatID" 
