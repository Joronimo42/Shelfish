...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <asp:Label ID="TitleLabel" runat="server" Font-Size="X-Large" Text="Edit Publishers"
        Font-Bold="True"></asp:Label>
    <br />
    <asp:SqlDataSource ID="SqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ApplicationServices %>"
        DeleteCommand="DELETE FROM [Publishers] WHERE [PublisherID] = @PublisherID" InsertCommand="INSERT INTO [Publishers] ([Name], [Address], [YearFounded]) VALUES (@Name, @Address, @YearFounded)"
        SelectCommand="SELECT * FROM [Publishers]" UpdateCommand="UPDATE [Publishers] SET [Name] = @Name, [Address] = @Address, [YearFounded] = @YearFounded WHERE [PublisherID] = @PublisherID">
        <DeleteParameters>
    ...
    <asp:ListView ID="ListView1" runat="server" DataKeyNames="PublisherID" DataSourceID="SqlDataSource"
        ...
        <AlternatingItemTemplate>
            <tr style="background-color: #FFF8DC;">
                ...
                <td>
                    <asp:Label ID="YearFoundedLabel" runat="server" Text='<%# Eval("YearFounded") %>' />
                </td>
            </tr>
        </AlternatingItemTemplate>
        <EditItemTemplate>
            <tr style="background-color: #008A8C; color: #FFFFFF;">
                ...
                <td>
                    <asp:TextBox ID="YearFoundedTextBox" runat="server" Text='<%# Bind("YearFounded") %>'
                        TextMode="Number" />
                </td>
            </tr>
        </EditItemTemplate>
