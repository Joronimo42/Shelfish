<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false"
    CodeFile="CheckoutHistory.aspx.vb" Inherits="Library_CheckoutResults" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    <asp:Label ID="TitleLabel" runat="server" Font-Size="X-Large" Text="Media Currently Checked Out"
    ...
    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt"
        ...
        <LocalReport ReportPath="Reports\CheckoutDetails.rdlc">
            <DataSources>
                ...
                <rsweb:ReportDataSource DataSourceId="CheckoutByPatronID" Name="CheckoutByCheckoutID" />
            </DataSources>
        </LocalReport>
    </rsweb:ReportViewer>
    <asp:ObjectDataSource ID="CheckoutByPatronID" runat="server" OldValuesParameterFormatString="original_{0}"
        SelectMethod="GetData" TypeName="ReportDataSetTableAdapters.CheckoutByPatronIDTableAdapter">
        <SelectParameters>
